...
class SendOrderMassData extends Field
{
    /**
     * @var string
     */
    protected $_template = 'Routee_WaymoreRoutee::system/config/sendOrdersMassData.phtml';
        ...
        $button = $this->getLayout()
            ...
            ->setData(
                [
                    ...
                    'disabled' => !$this->customerSynced() || $this->orderSynced()
                ]
            )
            ->setDataAttribute(
                [
